...
class DealGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "DealGetImageTask";
    ...
    DealGetImageTask(ImageView imageView) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        jsonObject.addProperty("dealNo", dealNo);//圖的id
